    ...
    for row in range(1, sheet.nrows):
        ...
        if len(row_values[5]) >= 1:
            try:
                ...
                # print(e)
                # print(f"image {row_values[5]} not found")
        ...
        price = write_price(f'{setting.price_file}', row_values[6], "tehran")
        if price is None:
        ...
        res = requests.post(f"{setting.base_api_uri}/services", headers={'Authorization': f"Bearer {auth_id}"}, json=data)
